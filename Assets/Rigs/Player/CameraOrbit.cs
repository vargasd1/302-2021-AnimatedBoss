...
public class CameraOrbit : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        /*if (moveScript)*/ transform.position = moveScript.transform.position;

        /*// if aiming, then turn camera's rotation to look at  target
    ...
    private void RotateCamToLookAtTarget()
    {
        ...
        if(IsTargeting())
        {
            // if targeting, set the rotation to look at the target 
    ...
    private void PlayerOrbitCamera()
    {
        ...
        else // not targeting / a sort of "free look"
        {
